...
class TestimonialImplTest {
    ...
    void getTestimonialDetailsWithMap() {
        ...
        assertEquals("A purpose is the eternal condition for success. Every former smoker can tell you just how hard it is to stop smoking cigarettes. However.", testimonial.getTestimonialDetailsWithMap().get(1).get("description"));
