package com.personalproject.core.services;
...
public class OSGiConfigImpl implements OSGiConfig{
    ...
    @ObjectClassDefinition(name="Personal Project - OSGi Configuration",
    ...
    public @interface ServiceConfig {
        ...
        public String serviceName() default "Personal Project Service";
